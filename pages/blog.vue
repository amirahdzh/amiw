<template>
  ...
  >
    ...
    <div
      class="max-w-7xl mx-auto py-10 px-5 flex flex-col md:flex-row gap-12 relative"
    >
      <!-- Blog Header (Minimalist + Subtle Effect) -->
      <div
      ...
      >
        ...
        <!-- Author Info -->
        <div
          class="flex items-center gap-4 mt-6 p-4 rounded-lg shadow-sm border border-gray-200"
        >
          <img
        ...
        <button
          ...
          class="mt-4 w-full max-w-[250px] px-5 py-2.5 text-sm font-medium bg-blue-600 text-white rounded-lg shadow-md hover:bg-blue-700 transition-all"
        >
          Open Medium Profile
        </button>
      </div>
